...
public class ProjectStageFour {
    ...
    public void buy(Scanner scanner, int water, int milk, int beans, int cups, int money) {
    ...
    public void fill(Scanner scanner, int water, int milk, int beans, int cups, int money) {
    ...
    public void take(int water, int milk, int beans, int cups, int money) {
